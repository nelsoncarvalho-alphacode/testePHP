...
if(isset($_POST["acao"])){
	...
	if ($totalregistro > 0){
		...
		$_SESSION["candidatos_session"] = $resultset['candidatos'];
		$_SESSION["vagas_session"] = $resultset['vagas'];
		$_SESSION["tipodevaga_session"] = $resultset['tipodevaga'];
...
<html lang="en">
  ...
  <body class="text-center">
	...
	<input type="hidden" name="acao" value="enviar">
	  <img class="img-fluid card-img-top" src="img/logo.png" alt="Alphacode">

...
class VagaCandidatoDAO {
    ...
    function consultarVagaCandidato($vagaCandidato){
		$sql  = " select vc.*,c.nome from vagacandidato vc  ";
		$sql  .= " inner join candidato c on      ";
		$sql  .= " vc.idcandidato = c.idcandidato ";
		$sql  .= " inner join vagas v on           ";
		$sql  .= " vc.idvaga = v.idvaga           ";
		$sql  .= " where 1=1 ";

...
<div class="d-flex justify-content-between align-items-center mb-3">
    <a class="btn btn-secondary mb-3" href="{{ route('clients.index') }}">Voltar</a>
    <div class="col-md-2">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <form action="{{ route('clients.restore', ['cliente' => $client->id]) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-success">Restaurar</button>
                            </form>
                            <form action="{{ route('clients.destroy', ['cliente' => $client->id]) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
